...
<jsp:useBean id="user" class="it.unitn.disi.sdeproject.beans.Trainer" scope="session"/>
<!DOCTYPE html>
<html>
...
<div class="w3-quarter">
    ...
    <div class="w3-sidebar w3-bar-block w3-border-right" style="display:none" id="mySidebar">
        ...
        <button class="w3-bar-item w3-button w3-hover-theme w3-ripple" onclick="load_subpage('workout_subpage')">Workout Request</button>
...
<div class="w3-container w3-half w3-margin-top">
    <div id="collaboration_subpage" class="w3-container subpage">
        <jsp:include page="home_Trainer/collaboration_subpage.jsp" />
    </div>

    <div id="workout_subpage" class="w3-container subpage" style="display:none">
        <jsp:include page="home_Trainer/workout_subpage.jsp" />
    </div>
